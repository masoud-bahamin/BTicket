  ...
  return (
    <>
      ...
      <footer className="bg-white">
        <div className="container pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
          <div className="xl:grid xl:grid-cols-3 xl:gap-8">
            <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
              <div className="md:grid md:grid-cols-2 md:gap-8">
                <div>
                  <h3 className="font-semibold leading-6 text-heading-text">
                    Solutions
                  </h3>
                  <ul role="list" className="mt-6 space-y-4">
                    <li>
                      <a
                        href="#"
                        className="text-sm leading-6 text-main-text font-medium hover:text-primary"
                      >
                        Marketing
                      </a>
                    </li>
            ...
            <div className="">
              ...
              <p className="font-semibold">Need live support?</p>
              <p className="font-semibold text-primary mb-2">
                bahaminwp@gmail.com
              </p>
          ...
          <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24">
            <p className="text-xs leading-5 text-gray-500 font-semibold">
              © 2024 Bahamin Company, Inc. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
