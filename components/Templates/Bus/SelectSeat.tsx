...
function SelectedSeat({ id, userId }: { id: string; userId: string }) {
  ...
  const getTicketInfo = async () => {
    try {
      ...
      if (res.status === 200) {
        ...
        const arr = makeSeats(27, data.reservedSeats);
        setSeats(arr);
      }
    } catch (error) {
  ...
  return (
    <div className="container">
      <div className="flex p-8 rounded-lg gap-4 bg-white">
        <div className="w-1/3">
          <div className=" my-8 flex flex-wrap p-4 border rounded-t-2xl max-w-[355px]">
            ...
            px-3 py-2 border mx-2 my-1 text-center w-16 flex rounded-md`}
                key={item.id}
        ...
        <div className="w-2/3 flex gap-10 py-8">
          <div className="px-4 min-w-64">
          ...
          <div className="w-full border-l pl-4">
            ...
            <div className="flex flex-wrap gap-1 mb-8 font-semibold">
              Total Fee: 360 $
            </div>
            <div className="flex justify-between w-full">
              ...
              <button
                ...
                className="mt-8 bg-primary hover:bg-secondary text-white py-1.5 px-10 rounded-lg"
              >
                Save And Send
              </button>
            </div>
